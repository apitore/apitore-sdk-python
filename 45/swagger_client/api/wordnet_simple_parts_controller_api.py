...
class WordnetSimplePartsControllerApi(object):
    ...
    def simple_translation_using_get(self, access_token, word, **kwargs):  # noqa: E501
        ...
        >>> thread = api.simple_translation_using_get(access_token, word, async=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async'):
            return self.simple_translation_using_get_with_http_info(access_token, word, **kwargs)  # noqa: E501
        else:
            (data) = self.simple_translation_using_get_with_http_info(access_token, word, **kwargs)  # noqa: E501
            return data

    def simple_translation_using_get_with_http_info(self, access_token, word, **kwargs):  # noqa: E501
        """Simple WordNet WebAPI. Return translation words.  # noqa: E501

        Japanese WordNet.<BR />Response<BR />&nbsp; Github: <a href=\"https://github.com/keigohtr/apitore-response-parent/tree/master/wordnet-response\">wordnet-response</a><BR />&nbsp; Class: com.apitore.banana.response.de.sciss.ws4j.LinksResponseEntity<BR />  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.simple_translation_using_get_with_http_info(access_token, word, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method simple_translation_using_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('access_token' not in params or
            ...
            raise ValueError("Missing the required parameter `access_token` when calling `simple_translation_using_get`")  # noqa: E501
        # verify the required parameter 'word' is set
        if ('word' not in params or
                params['word'] is None):
            raise ValueError("Missing the required parameter `word` when calling `simple_translation_using_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/wordnet-simple/translation', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
