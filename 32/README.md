...
api_instance = swagger_client.RssDesignControllerApi(swagger_client.ApiClient(configuration))
...
------------ | ------------- | ------------- | -------------
*RssDesignControllerApi* | [**feed_using_get4**](docs/RssDesignControllerApi.md#feed_using_get4) | **GET** /feeds/design | Get design feeds
