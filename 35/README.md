...
api_instance = swagger_client.RssTechControllerApi(swagger_client.ApiClient(configuration))
...
------------ | ------------- | ------------- | -------------
*RssTechControllerApi* | [**feed_using_get7**](docs/RssTechControllerApi.md#feed_using_get7) | **GET** /feeds/tech | Get tech feeds
