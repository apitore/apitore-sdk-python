...
api_instance = swagger_client.RssBlogControllerApi(swagger_client.ApiClient(configuration))
...
------------ | ------------- | ------------- | -------------
*RssBlogControllerApi* | [**feed_using_get2**](docs/RssBlogControllerApi.md#feed_using_get2) | **GET** /feeds/blog | Get pioneer blog feeds
